...
Function: 48平面编码
"""
from dlGame.encoders.base import Encoder
from dlGame.encoders.utils import is_ladder_escape, is_ladder_capture
from dlGame.gotypes import Point, Player
    ...
    def encode(self, game_state):
        ...
        for r in range(self.board_height):
            for c in range(self.board_width):
                ...
                if ages > 0:
                    age = int(offset("turns_since") + ages)
                    board_tensor[age][r][c] = 1
