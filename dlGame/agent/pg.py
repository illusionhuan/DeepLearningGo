...
from dlGame import encoders
from dlGame import goboard
from dlGame import kerasutil
...
class PolicyAgent(Agent):
    ...
    def train(self, experience, lr=0.0001, clipnorm=1.0, batch_size=512):
        ...
        # self._model.save('/root/autodl-tmp/alphago-code/examples/my_mode.h5')
